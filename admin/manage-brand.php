...
{ 
  ...
  <head>
    ...
    <title>Car Rental | Manage Brand</title>
    <meta charset="utf-8">
  ...
  <body class="app sidebar-mini rtl">
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-pencil"></i> Manage Brand</h1>
        </div>
      </div>
            ...
            <div class="tile-body">
             ...
             {?>
              <div class="alert alert-danger">
                ...
                <strong>Oh snap! Brand Success Deleted</strong>   <?php echo htmlentities($_SESSION['delmsg']);?><?php echo htmlentities($_SESSION['delmsg']="");?>
              </div>
            <?php } ?>
                    ...
                    {       ?>                   
                      ...
                      <tr>
                       ...
                       <td><a href="edit-brand.php?id=<?php echo $result->id;?>"><i class="fa fa-edit"></i></a>&nbsp;&nbsp;
                        <a href="manage-brand.php?del=<?php echo $result->id;?>" onclick="return confirm('Do you want to delete');"><i class="fa fa-close"></i></a></td>
                      </tr>
